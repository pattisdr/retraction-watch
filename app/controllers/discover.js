...
export default Ember.Controller.extend(Analytics, {
    ...
    facets: Ember.computed(function() {
        return [
            ...
            { key: 'publishers', title: this.get('i18n').t('discover.main.publisher'), component: 'search-facet-typeahead', base: 'agents', type: 'publisher' },
            { key: 'funders', title: this.get('i18n').t('discover.main.funder'), component: 'search-facet-typeahead', base: 'agents', type: 'funder' },
            { key: 'institutions', title: this.get('i18n').t('discover.main.institution'), component: 'search-facet-typeahead', base: 'agents', type: 'institution' },
            { key: 'organizations', title: this.get('i18n').t('discover.main.organization'), component: 'search-facet-typeahead', base: 'agents', type: 'organization' },
            { key: 'language', title: this.get('i18n').t('discover.main.language'), component: 'search-facet-language' },
            { key: 'contributors', title: this.get('i18n').t('discover.main.people'), component: 'search-facet-typeahead', base: 'agents', type: 'person' },
        ];
    }),
